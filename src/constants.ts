...
export const copy: Record<'nl' | 'en' | 'es', TranslationContent> = {
  nl: {
    ...
    storyBlocks: [
      ...
      { type: "paragraph", text: "Alles begon destijds op dag 1, het fundament waarop ik mijn allereerste meters in het zadel reed bij 'Forza Fortuna Planning' — want zo heette ons team toen, in parallel met het kantoor 'Fortuna Financial Planning'. Van die pioniersuren liep er een rechte lijn van 5 jaar naar de vroege digitale clubarchieven, waarna in 2014 de officiële vzw in de slipstream van het succes werd opgericht. Dat was het moment dat de naam veranderde naar Forza Fortuna Group voor het team en Fortuna <em>Financial Group</em> voor het kantoor, welke inmiddels haar 10-jarige mijlpaal achter de rug heeft. Wanneer we in het feestjaar 2029 aankomen, klopt het wielerhart van Fortuna <em>Financial Group</em> bovendien exact 15 jaar in mijn borst als Forza-lid. Het is die magische synchroniciteit van 15 jaar trouwe dienst, 15 jaar Forzahistorie en de kaap van 70 levensjaren die dit project zijn unieke glans geeft." },
      ...
      { type: "paragraph", text: "Met die vertrouwde 7 in het hart van de klimkilometers verweven, staat elke meter stijging symbool voor onze grensverleggende mentaliteit. Samen met Frank en FORZA FORTUNA <em>Financial Group</em> trap ik vol vertrouwen door naar de mooiste finishlijn uit mijn wielerloopbaan." },
      { type: "paragraph", text: "De teller loopt. De wiskunde klopt. Albir wacht." },
      { type: "paragraph", text: "Maar dit project gaat niet alleen over fietsen. Het gaat over het goede doel. Elke meter die geklommen wordt, elke zweetdruppel die valt, draagt bij aan een missie die groter is dan de sport zelf. En daar kan jij deel van uitmaken." }
    ],
    ...
    storySections: [['Van idee naar avontuur', 'Wat begon met de eerste plannen in 2026 groeide uit tot een grensverleggende uitdaging die sponsor, vrienden, en een heel team samenbrengt.'], ['Twee mijlpalen, één extremum', 'Vijftien jaar passie en betrokkenheid bij Forza Fortuna Financial Group. Zeventig jaar jong van geest. Twee mijlpalen die de lat op +17.500 hoogtemeters leggen.'], ['Samen trappen', 'Elke kilometer krijgt meer betekenis als we hem delen. Met supporters langs de weg, donateurs op afstand en het goede doel als ons kompas.']],
    routeTitle: 'De route',
    ...
    routeViewer: {
      ...
      downloadGpx: 'Download GPX', viewOnStrava: 'Bekijk op Strava', previewButton: 'BEKIJK RITTEN-PREVIEW', distance: 'Afstand', elevationGain: 'Hoogtewinst', elevationLoss: 'Hoogteverlies',
...
Laat maar iets horen — we staan voor je klaar.`,
  ...
  en: {
    ...
    introOfficial: 'In 2029, the cycling team Forza Fortuna Financial Group celebrates its crystal jubilee and I will have been part of this wonderful team for exactly 15 years. At the same time, I reach the legendary age of 70. These unique milestones merge into one extreme challenge: Project 15/70. For this challenge, I will spend 10 days in the saddle for **"Save the Children"**, with the ultimate goal of **+17,500** vertical meters in the Spanish mountains around Albir. To prove that with character and passion, anything is possible.',
    ...
    storyBlocks: [
      ...
      { type: "paragraph", text: "Everything began back on day 1, the foundation on which I rode my very first meters in the saddle with 'Forza Fortuna Planning' — for that was what our team was called then, in parallel with the office 'Fortuna Financial Planning'. From those pioneering hours there ran a straight line of 5 years to the early digital club archives, after which in 2014 the official non-profit organization was founded in the slipstream of success. That was the moment the name changed to Forza Fortuna Group for the team and Fortuna <em>Financial Group</em> for the office, which has by now passed its 10-year milestone. When we arrive in the festive year 2029, the cycling heart of Fortuna <em>Financial Group</em> will also have been beating in my chest as a Forza member for exactly 15 years. It is that magical synchronicity of 15 years of loyal service, 15 years of Forza history and the milestone of 70 years of life that gives this project its unique shine." },
      ...
      { type: "paragraph", text: "With that familiar 7 woven into the heart of the climbing kilometers, every meter of elevation gained symbolizes our boundary-pushing mentality. Together with Frank and FORZA FORTUNA <em>Financial Group</em>, I pedal with full confidence towards the most beautiful finish line of my cycling career." },
      { type: "paragraph", text: "The timer is running. The math adds up. Albir is waiting." },
      { type: "paragraph", text: "But this project is not just about cycling. It is about a good cause. Every meter climbed, every drop of sweat that falls, contributes to a mission greater than the sport itself. And you can be a part of it." }
    ],
    ...
    storySections: [['From idea to adventure', 'What started with the first plans in 2026 grew into a groundbreaking challenge that brings a sponsor, friends, and an entire team together.'], ['Two milestones, one extremum', 'Fifteen years of passion and dedication to Forza Fortuna Financial Group. Seventy years young at heart. Two milestones raising the bar to +17,500 meters of elevation.'], ['Pedaling together', 'Every kilometer gains more meaning when shared. With supporters along the way, remote donors, and our chosen charity as a compass.']],
    ...
    routeViewer: {
      ...
      downloadGpx: 'Download GPX', viewOnStrava: 'View on Strava', previewButton: 'VIEW ROUTE PREVIEW', distance: 'Distance', elevationGain: 'Elevation gain', elevationLoss: 'Elevation loss',
...
Let us know — we're here for you.`,
  ...
  es: {
    ...
    introOfficial: 'En 2029, el equipo ciclista Forza Fortuna Financial Group celebra su jubileo de cristal y yo llevo exactamente 15 años vinculado a este gran equipo. Al mismo tiempo alcanzo la legendaria edad de 70 años. Estos hitos únicos se funden en un desafío extremo: el Proyecto 15/70. Para este desafío, me subiré a la bicicleta durante 10 días por **"Save the Children"**, con el objetivo último de **+17.500** metros de desnivel en las montañas españolas alrededor de Albir. Para demostrar que con carácter y pasión todo es posible.',
    ...
    storyBlocks: [
      ...
      { type: "paragraph", text: "Todo comenzó entonces en el día 1, el fundamento sobre el que pedaleé mis primeros metros en el sillín con 'Forza Fortuna Planning' — porque así se llamaba nuestro equipo entonces, en paralelo con la oficina 'Fortuna Financial Planning'. De aquellas horas pioneras partía una línea recta de 5 años hacia los primeros archivos digitales del club, tras lo cual en 2014 se fundó la asociación oficial sin ánimo de lucro en la estela del éxito. Ese fue el momento en que el nombre cambió a Forza Fortuna Group para el equipo y Fortuna <em>Financial Group</em> para la oficina, la cual ya ha superado su hito de 10 años. Cuando lleguemos al año festivo 2029, el corazón ciclista de Fortuna <em>Financial Group</em> habrá latido exactamente 15 años en mi pecho como miembro de Forza. Es esa sincronicidad mágica de 15 años de leal servicio, 15 años de historia de Forza y la meta de 70 años de vida lo que le da a este proyecto su brillo único." },
      ...
      { type: "paragraph", text: "Con ese familiar 7 entretejido en el corazón de los kilómetros de escalada, cada metro de ascenso simboliza nuestra mentalidad de superar los límites. Junto a Frank y FORZA FORTUNA <em>Financial Group</em>, pedaleo con total confianza hacia la meta más bella de mi carrera ciclista." },
      { type: "paragraph", text: "El cronómetro corre. Las matemáticas cuadran. Albir espera." },
      { type: "paragraph", text: "Pero este proyecto no se trata solo de ciclismo. Se trata de una buena causa. Cada metro escalado, cada gota de sudor que cae, contribuye a una misión más grande que el deporte mismo. Y tú puedes ser parte de ello." }
    ],
    ...
    storySections: [['De la idea al aventura', 'Lo que comenzó con los primeros planes en 2026 se convirtió en un desafío innovador que une a patrocinador, amigos y a todo un equipo.'], ['Dos hitos, un extremo', 'Quince años de pasión y dedicación a Forza Fortuna Financial Group. Setenta años joven de espíritu. Dos hitos que sitúan el listón en +17.500 metros de desnivel.'], ['Pedaleando juntos', 'Cada kilómetro cobra más sentido cuando se comparte. Con seguidores en el camino, donantes a distancia y la buena causa como brújula.']],
    routeTitle: 'La ruta',
    ...
    routeViewer: {
      ...
      downloadGpx: 'Descargar GPX', viewOnStrava: 'Ver en Strava', previewButton: 'VER VISTA PREVIA DE LA RUTA', distance: 'Distancia', elevationGain: 'Desnivel positivo', elevationLoss: 'Desnivel negativo',
