...
export const copy: Record<'nl' | 'en' | 'es', TranslationContent> = {
  nl: {
    ...
    storyBlocks: [
      ...
      { type: "paragraph", text: "Alles begon destijds op dag 1, het fundament waarop ik mijn eerste meters in het zadel reed en de regel omarmde dat je per rit 1 punt verdient voor het klassement—een mooie parallel met het oprichtingsjaar 2001 van het kantoor." },
      { type: "paragraph", text: "Via een rechte lijn van 5 jaar groeide het wielerproject door naar de oprichting van de officiële vzw, die inmiddels haar 10-jarige mijlpaal viert." },
      { type: "paragraph", text: "Wanneer we in het feestjaar 2029 aankomen, klopt het wielerhart van FORZA FORTUNA <em>Financial Group</em> bovendien exact 15 jaar in mijn borst. Het is die unieke synchroniciteit van 15 jaar trouwe dienst, 15 jaar merkhistorie en 70 levensjaren die dit project zijn glans geeft." },
...
Laat maar iets horen — we staan voor je klaar.`,
  ...
  en: {
    ...
    storyBlocks: [
      ...
      { type: "paragraph", text: "It all started back on day 1, the absolute foundation when I rode my very first meters in the saddle and embraced the sacred rule of earning exactly 1 point per ride for the rankings—a beautiful parallel to the office's founding year in 2001." },
      { type: "paragraph", text: "Via a straight line of 5 years, the cycling project grew towards the foundation of the official non-profit organization (vzw), which is now celebrating its 10-year milestone." },
      { type: "paragraph", text: "When we arrive in the festive year of 2029, the cycling heart of FORZA FORTUNA <em>Financial Group</em> will also have been beating in my chest for exactly 15 years. It is this unique synchronicity of 15 years of loyal service, 15 years of brand history, and 70 years of life that gives this project its unique shine." },
...
Let us know — we're here for you.`,
  ...
  es: {
    ...
    storyBlocks: [
      ...
      { type: "paragraph", text: "Todo empezó en el día 1, la base absoluta cuando recorrí mis primeros metros en el sillín y adopté la sagrada regla de ganar exactamente 1 punto por etapa para la clasificación, un bonito paralelismo con el año de fundación de la oficina en 2001." },
      { type: "paragraph", text: "A través de una línea recta de 5 años, el proyecto ciclista creció hacia la fundación de la asociación oficial sin fines de lucro (vzw), que ahora celebra su hito de 10 años." },
      { type: "paragraph", text: "Cuando lleguemos al año festivo de 2029, el corazón ciclista de FORZA FORTUNA <em>Financial Group</em> habrá estado latiendo en mi pecho durante exactamente 15 años. Es esta sincronía única de 15 años de servicio leal, 15 años de historia de la marca y 70 años de vida lo que le da a este proyecto su brillo único." },
