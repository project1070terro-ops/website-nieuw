...
export const copy: Record<'nl' | 'en' | 'es', TranslationContent> = {
  nl: {
    ...
    introOfficial: "In 2029 viert wielerteam Forza Fortuna (vzw) haar 10-jarig jubileum en bereik ik de legendarische leeftijd van 70 jaar. Twee unieke mijlpalen, één extreme uitdaging. Met Project 15/70 kruip ik 10 dagen lang in het zadel voor het goede doel: +17.000 hoogtemeters in de Spaanse bergen rondom L'Albir. Bewijzen dat leeftijd slechts een getal is.",
...
Qua materiaal laat Terro niets aan het toeval over en wordt alles in eigen beheer perfect afgesteld. Voor de uitrusting kan hij rekenen op de onvoorwaardelijke steun van vriend/sponsor Frank Peeraer van Forza Fortuna (Fortuna Group), die ervoor zorgt dat Terro in de perfecte, aerodynamische en professionele uitrusting aan de start verschijnt.`]],
  ...
  en: {
    ...
    introOfficial: "In 2029, cycling team Forza Fortuna (vzw) celebrates its 10th anniversary and I reach the legendary age of 70. Two unique milestones, one extreme challenge. With Project 15/70 I will spend 10 days in the saddle for a good cause: +17,000 vertical meters in the Spanish mountains around L'Albir. Proving that age is just a number.",
...
That story became Project 15/70: an extreme cycling challenge in which Terro spends ten days in the saddle, conquering over 17,000 vertical meters in the Spanish mountains around L'Albir. It was no random choice; these mountains have been the backdrop for legendary rides and unforgettable friendships for over 15 years.`,
  ...
  es: {
    ...
    introOfficial: "En 2029, el equipo ciclista Forza Fortuna (vzw) celebra su 10º aniversario y yo alcanzo la legendaria edad de 70 años. Dos hitos únicos, un reto extremo. Con el Proyecto 15/70 pasaré 10 días en el sillín por una buena causa: +17.000 metros de desnivel en las montañas españolas alrededor de L'Albir. Demostrando que la edad es solo un número.",
...
Esa historia se convirtió en el Proyecto 15/70: un desafío ciclista extremo en el que Terro pasa diez días sobre el sillín, superando más de 17.000 metros de desnivel acumulado en las montañas españolas de los alrededores de L'Albir. No fue una elección casual; estas montañas han sido el escenario de rutas legendarias y amistades inolvidables durante más de 15 años.`,
