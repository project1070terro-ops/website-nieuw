...
export const copy: Record<'nl' | 'en' | 'es', TranslationContent> = {
  nl: {
    ...
    storyBlocks: [
      ...
      { type: "paragraph", text: "Alles begon destijds op dag 1, het fundament waarop ik mijn allereerste meters in het zadel reed bij 'Forza Fortuna Planning' — want zo heette ons team toen, in parallel met het kantoor 'Forza Fortuna Financial Planning'. Van die pioniersuren liep er een rechte lijn van 5 jaar naar de vroege digitale clubarchieven, waarna in 2014 de officiële vzw in de slipstream van het succes werd opgericht. Dat was het moment dat de naam veranderde naar Forza Fortuna Group voor het team en FORZA FORTUNA <em>Financial Group</em> voor het kantoor, welke inmiddels haar 10-jarige mijlpaal achter de rug heeft. Wanneer we in het feestjaar 2029 aankomen, klopt het wielerhart van FORZA FORTUNA <em>Financial Group</em> bovendien exact 15 jaar in mijn borst als Forza-lid. Het is die magische synchroniciteit van 15 jaar trouwe dienst, 15 jaar Forzahistorie en de kaap van 70 levensjaren die dit project zijn unieke glans geeft." },
...
Laat maar iets horen — we staan voor je klaar.`,
  ...
  en: {
    ...
    storyBlocks: [
      ...
      { type: "paragraph", text: "Everything began back on day 1, the foundation on which I rode my very first meters in the saddle with 'Forza Fortuna Planning' — for that was what our team was called then, in parallel with the office 'Forza Fortuna Financial Planning'. From those pioneering hours there ran a straight line of 5 years to the early digital club archives, after which in 2014 the official non-profit organization was founded in the slipstream of success. That was the moment the name changed to Forza Fortuna Group for the team and FORZA FORTUNA <em>Financial Group</em> for the office, which has by now passed its 10-year milestone. When we arrive in the festive year 2029, the cycling heart of FORZA FORTUNA <em>Financial Group</em> will also have been beating in my chest as a Forza member for exactly 15 years. It is that magical synchronicity of 15 years of loyal service, 15 years of Forza history and the milestone of 70 years of life that gives this project its unique shine." },
...
Let us know — we're here for you.`,
  ...
  es: {
    ...
    storyBlocks: [
      ...
      { type: "paragraph", text: "Todo comenzó entonces en el día 1, el fundamento sobre el que pedaleé mis primeros metros en el sillín con 'Forza Fortuna Planning' — porque así se llamaba nuestro equipo entonces, en paralelo con la oficina 'Forza Fortuna Financial Planning'. De aquellas horas pioneras partía una línea recta de 5 años hacia los primeros archivos digitales del club, tras lo cual en 2014 se fundó la asociación oficial sin ánimo de lucro en la estela del éxito. Ese fue el momento en que el nombre cambió a Forza Fortuna Group para el equipo y FORZA FORTUNA <em>Financial Group</em> para la oficina, la cual ya ha superado su hito de 10 años. Cuando lleguemos al año festivo 2029, el corazón ciclista de FORZA FORTUNA <em>Financial Group</em> habrá latido exactamente 15 años en mi pecho como miembro de Forza. Es esa sincronicidad mágica de 15 años de leal servicio, 15 años de historia de Forza y la meta de 70 años de vida lo que le da a este proyecto su brillo único." },
